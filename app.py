...
if current_tab == "Start":
    ...
    st.markdown("""
    <div class="text-box">
    <p><strong>Die Digitalisierung</strong> und der <strong>Wunsch nach flexibleren Arbeitsmodellen</strong> stellen produzierende Unternehmen vor neue Herausforderungen. Wie können beispielsweise mobile Arbeit und flexible Arbeitszeiten für die Beschäftigten in der Produktion umgesetzt werden? Das entwickelte <strong>arbeitswissenschaftliche Gestaltungsmodell</strong> hilft Ihnen dabei, diese Frage systematisch anzugehen: Es zeigt Ihnen, wo Ihr Unternehmen aktuell steht, und liefert konkrete <strong>Handlungsempfehlungen</strong>, die Sie auf dem <strong>Weg zur Einführung flexibler Arbeitsmodelle</strong> unterstützen.</p>
